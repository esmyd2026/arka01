...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // Después de StartSession (necesita $request->user()) y antes de
            // todo lo demás, para que absolutamente cualquier log de este
    ...
    protected $middlewareAliases = [
        ...
        'whatsapp.signed' => VerifyWhatsAppSignature::class,
    ];
}
