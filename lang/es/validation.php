...
/**
 * Bug real reportado por el usuario (con capturas: "The email has already
 * been taken." en pleno registro): no existía este archivo, así que
 * CUALQUIER regla de validación del framework sin mensaje a mano (Rule::in,
 * unique, required, min, etc., en cualquier formulario de la app) caía al
 * inglés de fábrica de Laravel — no era solo el correo del registro. APP_LOCALE
 * ya está en "es" (.env), pero eso no alcanza sin este archivo: sin él,
 * Laravel cae al inglés de vendor/laravel/framework/.../lang/en/validation.php.
 */
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado apareció en una filtración de datos conocida. Elija un :attribute distinto.',
    ],
    ...
    // Nombres legibles para que los mensajes de arriba no digan "el campo
    // phone_local es obligatorio" sino "el campo teléfono es obligatorio" —
    // cubre los campos de los formularios reales de la app; uno que falte
    // acá simplemente cae al nombre crudo del campo (con guiones bajos
    // cambiados por espacios), no rompe nada.
    'attributes' => [
        'name' => 'nombre',
        ...
        'license_photo' => 'foto de la licencia',
        ...
        'max_request_distance_km' => 'distancia máxima de cobertura',
        'total_points' => 'puntos',
