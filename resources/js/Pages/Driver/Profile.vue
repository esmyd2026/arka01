            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-4 sm:p-8 bg-arka-card shadow sm:rounded-arka">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <!-- Pedido explícito del usuario: dejar elegir si una
                             invitación de flota necesita su aceptación
                        ...
                        <div class="rounded-xl border border-arka-border p-3.5">
                            ...
                            <InputError class="mt-2" :message="form.errors.requires_fleet_invitation_approval" />
                        </div>
