...
<template>
    <section class="space-y-6">
        <header>
            <h2 class="text-lg font-medium text-arka-text">Eliminar cuenta</h2>

            <p class="mt-1 text-sm text-arka-text-muted">
                Una vez que elimine su cuenta, todos sus datos se borran para siempre. Descargue lo que quiera
