        ...
        <div v-else>
                ...
                <div class="mt-5 grid grid-cols-1 gap-2.5">
                    <button
                        ...
                        :class="isSelected(option.key)
                            ...
                            : 'border-arka-border bg-arka-base/60 text-arka-text hover:border-arka-primary/50'"
            ...
            <div v-else class="text-center py-4">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener"
                    class="mt-6 inline-flex items-center justify-center gap-2 w-full rounded-arka bg-arka-primary px-5 py-3 text-sm font-bold uppercase tracking-wide text-white hover:bg-arka-primary-bright transition"
                >
                ...
                <Link
                    href="/"
                    class="mt-3 inline-flex items-center justify-center gap-1.5 w-full rounded-arka border border-arka-border px-4 py-2 text-xs font-semibold text-arka-text-muted hover:text-arka-text hover:border-arka-primary/40 transition"
                >
