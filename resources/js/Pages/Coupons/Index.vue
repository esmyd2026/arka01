                    ...
                    <div v-for="coupon in coupons" :key="coupon.id" class="bg-arka-card shadow rounded-arka overflow-hidden flex flex-col">
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            ...
                            <a
                                ...
                                class="mt-3 inline-flex items-center justify-center px-4 py-2 bg-arka-primary border border-transparent rounded-arka font-semibold text-xs text-white uppercase tracking-widest hover:bg-arka-primary-bright transition"
                            >
